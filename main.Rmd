...
```{r plot s, message=FALSE, warning=FALSE}
...
```{r plot e, message=FALSE, warning=FALSE}
xvals = as.numeric(colnames(x))
...
ggplot(stack_plot_me, aes(x = negativity_binned, y = proportion)) + geom_area(aes(fill = race_ethn))
```
