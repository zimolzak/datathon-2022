...
```{r export}
write.csv(done_searching, here('analytic.csv'))

done_searching %>%
  head() %>%
  write.csv(here('head_analytic.csv'))
```
...
1. Make a separate pdf for presentation to team / large group (via export CSV)
2. Consider showing which descriptor (arrange like doc:term matrix)
3. Join note chunks

## Meh

1. Exclude stopwords (maybe n/a)
2. Show length distribution of notes
3. Dunning log-likelihood
