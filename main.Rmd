...
We see that disposition=Discharge goes with class=Emergency but not perfectly? Likewise, Admit goes with Inpatient. Obviously, Observation goes with Observation, but not as much as class=Inpatient. Aldo disposition=Admit goes with class=Observation. Very few class=Outpatient at all.

Also very few class=Emergency and disposition=Admit.

This is all possibly because we requested ER discharge to home and not admit?
