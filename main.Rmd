...
- More women when negative descriptors = 1, but fewer when = 2, 3, 4.
...
**Observations in brief:** Number of patients is 3728. 2:1 white:black. Most common employment is retired. Most are married. 2:1 nonmedicaid vs yes. Most common financial status is: managed care, or Medicare managed care.
...
**Figure. Notes per patient.** About 35 patients have only one note.

## Zoomed in notes per patient
...
**Figure. Zoomed in notes per patient.** Many people have dozens of notes. Plenty have hundreds. A few have thousands(!)
...
**Table. Sex vs. negative descriptors.** More women when negativity = 1.
