...
See especially the section near the end called **RESULTS more concise.** This has tables, hypothesis tests, and one stacked bar plot.
...
```
```{r fisher, echo=FALSE}
fisher.test(final_race) -> final_race_t
final_race_t
```
...
-  More repeatable results summary at end
