...
negative descriptor words (and word variants), in 100 BCM patients who
...
**Figure. Distribution of race/ethnicity, in notes without negative
descriptors, compared to notes with negative descriptors.** Latino
...
**Table 1. Distribution of race/ethnicity, in notes without negative
descriptors, compared to notes with negative descriptors.** The column
"TRUE" means notes with one of the negative descriptors.
